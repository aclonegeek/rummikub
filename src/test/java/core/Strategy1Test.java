...
public class Strategy1Test extends TestCase {
    ...
    public void testDetermineInitialMove1() {
        ...
        assertEquals("[{R4 R5 R6 R7 R8}]", strategy1.determineInitialMove(hand, workspace).toString());
    }
    ...
    public void testDetermineInitialMove2() {
        ...
        assertEquals("[{G5 G6 G7}, {R3 R4 R5}, {O2 O3 O4}]", strategy1.determineInitialMove(hand, workspace).toString());
    }
    ...
    public void testDetermineInitialMove3() {
        ...
        assertEquals(null, strategy1.determineInitialMove(hand, workspace));
    }
    ...
    public void testRegularMove1() {
        ...
        assertEquals("[{R1 R2 R3}, {G1 G2 G3 G4}]", strategy1.determineRegularMove(hand, workspace).toString());
    ...
    public void testRegularMove2() {
        ...
        assertEquals("[{R1 R2 R3}, {B1 G1 O1}]", strategy1.determineRegularMove(hand, workspace).toString());
        assertEquals("[B1 B2]", hand.toString());
    }
    ...
    public void testRegularMove3() {
        ...
        assertEquals("[{R1 R2 R3}, {R5 R6 R7}, {B1 B2 B3}, {O9 O10 O11}]", strategy1.determineRegularMove(hand, workspace).toString());
    ...
    public void testRegularMove4() {
        ...
        assertEquals("[{R1 R2 R3}, {R10 B10 G10}, {B1 G1 O1}, {B6 G6 O6}]", strategy1.determineRegularMove(hand, workspace).toString());
        assertEquals("[]", hand.toString());
    }
    ...
    public void testRegularMove5() {
        ...
        assertEquals("[{R1 R2 R3}, {R6 R7 R8}, {B1 G1 O1}]", strategy1.determineRegularMove(hand, workspace).toString());
        assertEquals("[]", hand.toString());
    }
    ...
    public void testRegularMove6() {
        ...
        assertEquals("[{R1 R2 R3 R4}]", strategy1.determineRegularMove(hand, workspace).toString());
    ...
    public void testRegularMove7() {
        ...
        assertEquals("[{R1 G1 B1 O1}]", strategy1.determineRegularMove(hand, workspace).toString());
    ...
    public void testRegularMove8() {
        ...
        assertEquals("[{R1 R2 R3 R4 R5 R6}]", strategy1.determineRegularMove(hand, workspace).toString());
        assertEquals("[]", hand.toString());
    }
    ...
    public void testRegularMove9() {
        ...
        assertEquals("[{R2 R3 R4}, {R1 R2 R3}]", strategy1.determineRegularMove(hand, workspace).toString());
    ...
    public void testRegularMove10() {
        ...
        assertEquals("[{G1 B1 R1}, {R1 R2 R3}, {O1 O2 O3}]", strategy1.determineRegularMove(hand, workspace).toString());
    ...
    public void testRegularMove12() {
        ...
        assertEquals("[{R1 R2 R3}, {O5 O6 O7 O8}, {B1 B2 B3}, {G4 R4 O4 B4}]", strategy1.determineRegularMove(hand, workspace).toString());
        assertEquals("[]", hand.toString());
    }

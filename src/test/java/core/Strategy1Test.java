...
public class Strategy1Test  extends TestCase {
    ...
    public void testDetermineInitialMove2() {
        ...
        assertEquals("[{G5,G6,G7}, {R3,R4,R5}, {O2,O3,O4}]", strategy1.determineMove(workspace, hand, true).toString());
    }
    ...
    public void testDetermineRegularMove1() {
        ...
        assertEquals("[{R1,R2,R3,R4}, {G9,B9,R9,O9}, {R10,B10,G10,O10}, {G5,G6,G7}]", strategy1.determineMove(workspace, hand, false).toString());
    }
    ...
    public void testDetermineRegularMove2() {
        ...
        assertEquals(null, strategy1.determineMove(workspace, hand, false));
    }
}
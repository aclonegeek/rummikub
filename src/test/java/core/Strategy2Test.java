...
public class Strategy2Test extends TestCase {
    ...
    public void testDetermineInitialMove6() {
        ...
        Hand hand = new Hand("G10,O10,J,R1,R2,R3,R4");
        assertEquals("[{R1 R2 R3}, {R10 O10 G10 B10}, {B5 B6 B7 B8}, {G10 O10 J}]", strategy2.determineInitialMove(hand, workspace).toString());
    }
    ...
    public void testDetermineRegularMove4() {
        ...
        Hand hand = new Hand("R2,R3,R7,G1");
        assertEquals("[{R2 R3 R4 R5 R6 R7}, {G3 G4 G5}, {R3 B3 O3}, {R1 R2 R3}, {G1 G2 G3}]", strategy2.determineRegularMove(hand, workspace).toString());
        assertEquals(0, hand.getSize());
    }
    ...
    public void testDetermineRegularMove5() {
        ...
        Hand hand = new Hand("R2,R3,R7,G1,O7");
        assertEquals("[{R2 R3 R4 R5 R6 R7}, {G3 G4 G5}, {R3 B3 O3}, {R1 R2 R3}, {G1 G2 G3}]", strategy2.determineRegularMove(hand, workspace).toString());
        assertEquals(1, hand.getSize());
    }
    
    // Plays melds with jokers
    public void testDetermineRegularMove6() {
        Strategy2 strategy2 = new Strategy2();
        ArrayList<Meld> workspace = new ArrayList<>();
